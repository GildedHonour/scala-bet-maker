...
public class Market {
    ...
    @Getter
    @Setter
    private Date bfLastUpdateTime;

    @Getter
    @Setter
    private Date bqLastUpdateTime;

    @Getter
    @Setter
    private Date bfPreviousUpdateTime;

    @Getter
    @Setter
    private Date bqPreviousUpdateTime;
