...
public class BetLog
{
	...
	@Getter @Setter  private Date			  timeSent;
	@Getter @Setter  private int		   	marketId;
	@Getter @Setter  private int			  selectionId;
	@Getter @Setter  private String			market;
	@Getter @Setter  private String			direction;
	@Getter @Setter  private Double			odds;
	@Getter @Setter  private Double			amount;
	@Getter @Setter  private String			betStatus;
	@Getter @Setter  private Double			amountFilled;
	@Getter @Setter  private String			betfairBetId;
	@Getter @Setter  private String			betDescription;
	@Getter @Setter  private int			  externalMarketId;
	@Getter @Setter  private String			externalCode;
	@Getter @Setter  private String 		betSource;
	@Getter @Setter  private int			  referenceBetId;
	@Getter @Setter  private int			  exchangeId;

  @Getter @Setter  private int        fillCount;

  @Getter @Setter  private String     globalToleranceReason;

  @Getter @Setter  private Date       matchedAt;
